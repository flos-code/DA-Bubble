...
@Component({
  selector: 'app-edit-own-message',
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MainChatComponent, PickerComponent, EmojiComponent ],
  templateUrl: './edit-own-message.component.html',
  styleUrl: './edit-own-message.component.scss'
})
export class EditOwnMessageComponent implements OnInit {
